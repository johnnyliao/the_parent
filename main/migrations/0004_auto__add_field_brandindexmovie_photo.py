...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BrandIndexMovie.photo'
        db.add_column(u'main_brandindexmovie', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BrandIndexMovie.photo'
        db.delete_column(u'main_brandindexmovie', 'photo')
