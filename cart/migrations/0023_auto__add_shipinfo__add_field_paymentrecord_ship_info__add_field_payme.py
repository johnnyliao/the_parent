...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShipInfo'
        db.create_table(u'cart_shipinfo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('city', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('district', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'cart', ['ShipInfo'])

        # Adding field 'PayMentRecord.ship_info'
        db.add_column(u'cart_paymentrecord', 'ship_info',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='user_payment_record', null=True, to=orm['cart.ShipInfo']),
                      keep_default=False)

        # Adding field 'PayMentRecord.ship_time'
        db.add_column(u'cart_paymentrecord', 'ship_time',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ShipInfo'
        db.delete_table(u'cart_shipinfo')

        # Deleting field 'PayMentRecord.ship_info'
        db.delete_column(u'cart_paymentrecord', 'ship_info_id')

        # Deleting field 'PayMentRecord.ship_time'
        db.delete_column(u'cart_paymentrecord', 'ship_time')
    ...
    models = {
        ...
        u'cart.paymentrecord': {
            ...
            'ship_time': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
