...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductInfo.item_photo'
        db.add_column(u'cart_productinfo', 'item_photo',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ProductInfo.item_photo'
        db.delete_column(u'cart_productinfo', 'item_photo')
    ...
    models = {
        ...
        u'cart.productinfo': {
            ...
            'item_photo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
