...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cart_cartitem', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cart.ProductInfo']))

    def backwards(self, orm):

        # Changing field 'CartItem.product'
        db.alter_column(u'cart_cartitem', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.User']))
