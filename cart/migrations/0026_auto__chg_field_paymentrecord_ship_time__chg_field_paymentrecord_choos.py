...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PayMentRecord.ship_time'
        db.alter_column(u'cart_paymentrecord', 'ship_time', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'PayMentRecord.choose_payment'
        db.alter_column(u'cart_paymentrecord', 'choose_payment', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'PayMentRecord.ship_time'
        db.alter_column(u'cart_paymentrecord', 'ship_time', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'PayMentRecord.choose_payment'
        db.alter_column(u'cart_paymentrecord', 'choose_payment', self.gf('django.db.models.fields.IntegerField')(null=True))
