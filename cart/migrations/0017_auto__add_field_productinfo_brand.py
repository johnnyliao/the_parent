...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductInfo.brand'
        db.add_column(u'cart_productinfo', 'brand',
                      self.gf('django.db.models.fields.CharField')(default='flower', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductInfo.brand'
        db.delete_column(u'cart_productinfo', 'brand')
