...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductInfo.unit'
        db.add_column(u'cart_productinfo', 'unit',
                      self.gf('django.db.models.fields.CharField')(default='aa', max_length=10),
                      keep_default=False)


        # Changing field 'ProductInfo.trade_desc'
        db.alter_column(u'cart_productinfo', 'trade_desc', self.gf('mezzanine.core.fields.RichTextField')(max_length=2000))

    def backwards(self, orm):
        # Deleting field 'ProductInfo.unit'
        db.delete_column(u'cart_productinfo', 'unit')


        # Changing field 'ProductInfo.trade_desc'
        db.alter_column(u'cart_productinfo', 'trade_desc', self.gf('django.db.models.fields.CharField')(max_length=30))
