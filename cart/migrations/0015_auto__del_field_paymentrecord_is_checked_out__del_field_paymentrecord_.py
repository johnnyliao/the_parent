...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PayMentRecord.is_checked'
        db.add_column(u'cart_paymentrecord', 'is_checked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PayMentRecord.checked_time'
        db.add_column(u'cart_paymentrecord', 'checked_time',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PayMentRecord.is_checked'
        db.delete_column(u'cart_paymentrecord', 'is_checked')

        # Deleting field 'PayMentRecord.checked_time'
        db.delete_column(u'cart_paymentrecord', 'checked_time')
