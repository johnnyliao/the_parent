...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FavoriteItem'
        db.create_table(u'cart_favoriteitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_favorite_item', to=orm['account.User'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_favorite_product', to=orm['cart.ProductInfo'])),
        ))
        db.send_create_signal(u'cart', ['FavoriteItem'])


    def backwards(self, orm):
        # Deleting model 'FavoriteItem'
        db.delete_table(u'cart_favoriteitem')
