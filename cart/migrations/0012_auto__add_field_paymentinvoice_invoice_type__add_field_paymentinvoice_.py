...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PayMentInvoice.invoice_type'
        db.add_column(u'cart_paymentinvoice', 'invoice_type',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'PayMentInvoice.invoice_kind'
        db.add_column(u'cart_paymentinvoice', 'invoice_kind',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PayMentInvoice.invoice_type'
        db.delete_column(u'cart_paymentinvoice', 'invoice_type')

        # Deleting field 'PayMentInvoice.invoice_kind'
        db.delete_column(u'cart_paymentinvoice', 'invoice_kind')
