...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'UserInvoice', fields ['user']
        db.delete_unique(u'cart_userinvoice', ['user_id'])


        # Changing field 'UserInvoice.user'
        db.alter_column(u'cart_userinvoice', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.User']))

    def backwards(self, orm):

        # Changing field 'UserInvoice.user'
        db.alter_column(u'cart_userinvoice', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['account.User']))
        # Adding unique constraint on 'UserInvoice', fields ['user']
        db.create_unique(u'cart_userinvoice', ['user_id'])
    ...
    models = {
        ...
        u'cart.productinfo': {
            ...
            'item_photo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        u'cart.userinvoice': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_invoice'", 'to': u"orm['account.User']"})
        },
