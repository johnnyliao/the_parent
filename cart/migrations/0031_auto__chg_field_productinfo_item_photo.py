...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductInfo.item_photo'
        db.alter_column(u'cart_productinfo', 'item_photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'ProductInfo.item_photo'
        db.alter_column(u'cart_productinfo', 'item_photo', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100))
