...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CartItem.checked_date'
        db.alter_column(u'cart_cartitem', 'checked_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'CartItem.checked_date'
        db.alter_column(u'cart_cartitem', 'checked_date', self.gf('django.db.models.fields.DateTimeField')(default=''))
