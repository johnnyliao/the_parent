...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PayMentRecord.total_amount'
        db.add_column(u'cart_paymentrecord', 'total_amount',
                      self.gf('django.db.models.fields.IntegerField')(default=10000),
                      keep_default=False)

        # Adding M2M table for field cart on 'PayMentRecord'
        m2m_table_name = db.shorten_name(u'cart_paymentrecord_cart')
        ...
        db.create_unique(m2m_table_name, ['paymentrecord_id', 'cartitem_id'])


    def backwards(self, orm):
        # Deleting field 'PayMentRecord.total_amount'
        db.delete_column(u'cart_paymentrecord', 'total_amount')

        # Removing M2M table for field cart on 'PayMentRecord'
        db.delete_table(db.shorten_name(u'cart_paymentrecord_cart'))
