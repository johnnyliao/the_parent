...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BrandBanner'
        db.create_table(u'cart_brandbanner', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('banner', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'cart', ['BrandBanner'])

        # Adding model 'BrandMovie'
        db.create_table(u'cart_brandmovie', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('link', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'cart', ['BrandMovie'])

        # Adding model 'Brand'
        db.create_table(u'cart_brand', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('brand_name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'cart', ['Brand'])

        # Adding M2M table for field banner on 'Brand'
        m2m_table_name = db.shorten_name(u'cart_brand_banner')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('brand', models.ForeignKey(orm[u'cart.brand'], null=False)),
            ('brandbanner', models.ForeignKey(orm[u'cart.brandbanner'], null=False))
        ))
        db.create_unique(m2m_table_name, ['brand_id', 'brandbanner_id'])

        # Adding M2M table for field movie on 'Brand'
        m2m_table_name = db.shorten_name(u'cart_brand_movie')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('brand', models.ForeignKey(orm[u'cart.brand'], null=False)),
            ('brandmovie', models.ForeignKey(orm[u'cart.brandmovie'], null=False))
        ))
        db.create_unique(m2m_table_name, ['brand_id', 'brandmovie_id'])

        # Adding field 'ProductInfo.in_stock'
        db.add_column(u'cart_productinfo', 'in_stock',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ProductInfo.ship_way'
        db.add_column(u'cart_productinfo', 'ship_way',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)

        # Adding field 'ProductInfo.ship_day'
        db.add_column(u'cart_productinfo', 'ship_day',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)

        # Adding field 'ProductInfo.other'
        db.add_column(u'cart_productinfo', 'other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'BrandBanner'
        db.delete_table(u'cart_brandbanner')

        # Deleting model 'BrandMovie'
        db.delete_table(u'cart_brandmovie')

        # Deleting model 'Brand'
        db.delete_table(u'cart_brand')

        # Removing M2M table for field banner on 'Brand'
        db.delete_table(db.shorten_name(u'cart_brand_banner'))

        # Removing M2M table for field movie on 'Brand'
        db.delete_table(db.shorten_name(u'cart_brand_movie'))

        # Deleting field 'ProductInfo.in_stock'
        db.delete_column(u'cart_productinfo', 'in_stock')

        # Deleting field 'ProductInfo.ship_way'
        db.delete_column(u'cart_productinfo', 'ship_way')

        # Deleting field 'ProductInfo.ship_day'
        db.delete_column(u'cart_productinfo', 'ship_day')

        # Deleting field 'ProductInfo.other'
        db.delete_column(u'cart_productinfo', 'other')
    ...
    models = {
        ...
        u'cart.productinfo': {
            ...
            'brand': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
