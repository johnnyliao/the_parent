...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cart_productimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal(u'cart', ['ProductImage'])

        # Deleting field 'ProductInfo.photo'
        db.delete_column(u'cart_productinfo', 'photo')

        # Adding field 'ProductInfo.video_link'
        db.add_column(u'cart_productinfo', 'video_link',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding M2M table for field photo on 'ProductInfo'
        m2m_table_name = db.shorten_name(u'cart_productinfo_photo')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('productinfo', models.ForeignKey(orm[u'cart.productinfo'], null=False)),
            ('productimage', models.ForeignKey(orm[u'cart.productimage'], null=False))
        ))
        db.create_unique(m2m_table_name, ['productinfo_id', 'productimage_id'])


    def backwards(self, orm):
        # Deleting model 'ProductImage'
        db.delete_table(u'cart_productimage')

        # Adding field 'ProductInfo.photo'
        db.add_column(u'cart_productinfo', 'photo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Deleting field 'ProductInfo.video_link'
        db.delete_column(u'cart_productinfo', 'video_link')

        # Removing M2M table for field photo on 'ProductInfo'
        db.delete_table(db.shorten_name(u'cart_productinfo_photo'))
