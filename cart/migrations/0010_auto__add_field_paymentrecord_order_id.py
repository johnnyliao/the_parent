...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PayMentRecord.order_id'
        db.add_column(u'cart_paymentrecord', 'order_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PayMentRecord.order_id'
        db.delete_column(u'cart_paymentrecord', 'order_id')
