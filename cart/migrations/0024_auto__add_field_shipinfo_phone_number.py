...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShipInfo.phone_number'
        db.add_column(u'cart_shipinfo', 'phone_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShipInfo.phone_number'
        db.delete_column(u'cart_shipinfo', 'phone_number')
