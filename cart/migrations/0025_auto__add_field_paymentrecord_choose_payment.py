...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PayMentRecord.choose_payment'
        db.add_column(u'cart_paymentrecord', 'choose_payment',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PayMentRecord.choose_payment'
        db.delete_column(u'cart_paymentrecord', 'choose_payment')
    ...
    models = {
        ...
        u'cart.paymentrecord': {
            ...
            'choose_payment': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
