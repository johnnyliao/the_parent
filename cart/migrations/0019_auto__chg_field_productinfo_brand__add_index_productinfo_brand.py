...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'ProductInfo.brand' to match new field type.
        db.rename_column(u'cart_productinfo', 'brand', 'brand_id')
        # Changing field 'ProductInfo.brand'
        db.alter_column(u'cart_productinfo', 'brand_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cart.Brand']))
        # Adding index on 'ProductInfo', fields ['brand']
        db.create_index(u'cart_productinfo', ['brand_id'])


    def backwards(self, orm):
        # Removing index on 'ProductInfo', fields ['brand']
        db.delete_index(u'cart_productinfo', ['brand_id'])


        # Renaming column for 'ProductInfo.brand' to match new field type.
        db.rename_column(u'cart_productinfo', 'brand_id', 'brand')
        # Changing field 'ProductInfo.brand'
        db.alter_column(u'cart_productinfo', 'brand', self.gf('django.db.models.fields.CharField')(max_length=10))
