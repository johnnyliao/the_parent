...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserInvoice'
        db.create_table(u'cart_userinvoice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('customer_identifier', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True)),
            ('customer_name', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('customer_addr', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('customer_phone', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('customer_email', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='user_invoice', unique=True, to=orm['account.User'])),
        ))
        db.send_create_signal(u'cart', ['UserInvoice'])

        # Adding field 'PayMentInvoice.record'
        db.add_column(u'cart_paymentinvoice', 'record',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='payment_record_', unique=True, null=True, to=orm['cart.PayMentRecord']),
                      keep_default=False)

        # Deleting field 'PayMentRecord.invoice'
        db.delete_column(u'cart_paymentrecord', 'invoice_id')

        # Adding field 'ProductInfo.size'
        db.add_column(u'cart_productinfo', 'size',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'UserInvoice'
        db.delete_table(u'cart_userinvoice')

        # Deleting field 'PayMentInvoice.record'
        db.delete_column(u'cart_paymentinvoice', 'record_id')

        # Adding field 'PayMentRecord.invoice'
        db.add_column(u'cart_paymentrecord', 'invoice',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='payment_record_invoice', unique=True, null=True, to=orm['cart.PayMentInvoice'], blank=True),
                      keep_default=False)

        # Deleting field 'ProductInfo.size'
        db.delete_column(u'cart_productinfo', 'size')
