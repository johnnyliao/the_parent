...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductInfo.video_photo'
        db.add_column(u'cart_productinfo', 'video_photo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'ProductInfo.video_link'
        db.alter_column(u'cart_productinfo', 'video_link', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):
        # Deleting field 'ProductInfo.video_photo'
        db.delete_column(u'cart_productinfo', 'video_photo')


        # Changing field 'ProductInfo.video_link'
        db.alter_column(u'cart_productinfo', 'video_link', self.gf('django.db.models.fields.CharField')(default='', max_length=50))
