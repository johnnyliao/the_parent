...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'action_comment', 'comment_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Comment.href'
        db.add_column(u'action_comment', 'href',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'action_comment', 'comment_id')

        # Deleting field 'Comment.href'
        db.delete_column(u'action_comment', 'href')
    ...
    models = {
        ...
        u'action.comment': {
            ...
            'comment_id': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
