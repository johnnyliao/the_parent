...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'action_recomment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_re_comment', to=orm['account.User'])),
            ('content', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('re_comment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='re_comment', to=orm['action.Comment'])),
        ))
        db.send_create_signal(u'action', ['ReComment'])


    def backwards(self, orm):
        # Deleting model 'ReComment'
        db.delete_table(u'action_recomment')
    ...
    models = {
        ...
        u'action.comment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_comment'", 'to': u"orm['account.User']"})
        },
        u'action.recomment': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            're_comment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'re_comment'", 'to': u"orm['action.Comment']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_re_comment'", 'to': u"orm['account.User']"})
        },
        u'auth.group': {
