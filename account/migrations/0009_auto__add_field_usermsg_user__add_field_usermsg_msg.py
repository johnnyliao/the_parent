...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserMsg.user'
        db.add_column(u'account_usermsg', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='user_msgs', to=orm['account.User']),
                      keep_default=False)

        # Adding field 'UserMsg.msg'
        db.add_column(u'account_usermsg', 'msg',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='user_msg_msg', to=orm['account.Message']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserMsg.user'
        db.delete_column(u'account_usermsg', 'user_id')

        # Deleting field 'UserMsg.msg'
        db.delete_column(u'account_usermsg', 'msg_id')
