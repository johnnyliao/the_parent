...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'WinningData', fields ['name']
        db.create_unique(u'account_winningdata', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'WinningData', fields ['name']
        db.delete_unique(u'account_winningdata', ['name'])
