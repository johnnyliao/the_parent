...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'account_user', 'year',
                      self.gf('django.db.models.fields.IntegerField')(default=11),
                      keep_default=False)

        # Adding field 'User.sex'
        db.add_column(u'account_user', 'sex',
                      self.gf('django.db.models.fields.CharField')(default='man', max_length=10),
                      keep_default=False)

        # Adding field 'User.birthday'
        db.add_column(u'account_user', 'birthday',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2017, 1, 3, 0, 0)),
                      keep_default=False)

        # Adding field 'User.address'
        db.add_column(u'account_user', 'address',
                      self.gf('django.db.models.fields.CharField')(default='aaa', max_length=60),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.year'
        db.delete_column(u'account_user', 'year')

        # Deleting field 'User.sex'
        db.delete_column(u'account_user', 'sex')

        # Deleting field 'User.birthday'
        db.delete_column(u'account_user', 'birthday')

        # Deleting field 'User.address'
        db.delete_column(u'account_user', 'address')
