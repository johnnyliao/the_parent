...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserMsg.is_read'
        db.add_column(u'account_usermsg', 'is_read',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'account_usermsg', 'msg',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='user_msg_msg', to=orm['account.Message']),
                      keep_default=False)

        # Deleting field 'UserMsg.is_read'
        db.delete_column(u'account_usermsg', 'is_read')
