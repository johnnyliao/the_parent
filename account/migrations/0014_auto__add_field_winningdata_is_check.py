...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WinningData.is_check'
        db.add_column(u'account_winningdata', 'is_check',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WinningData.is_check'
        db.delete_column(u'account_winningdata', 'is_check')
