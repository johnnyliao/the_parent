...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WinningData'
        db.create_table(u'account_winningdata', (
        ...
        db.send_create_signal(u'account', ['WinningData'])


    def backwards(self, orm):
        # Deleting model 'WinningData'
        db.delete_table(u'account_winningdata')
