...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserVerify'
        db.create_table(u'account_userverify', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='verify', unique=True, to=orm['account.User'])),
            ('verification_hash', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('send_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('active_minutes', self.gf('django.db.models.fields.IntegerField')(default=5)),
            ('is_send', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('date_verified', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ))
        db.send_create_signal(u'account', ['UserVerify'])


    def backwards(self, orm):
        # Deleting model 'UserVerify'
        db.delete_table(u'account_userverify')
    ...
    models = {
        ...
        u'account.userverify': {
            ...
            'active_minutes': ('django.db.models.fields.IntegerField', [], {'default': '5'}),
