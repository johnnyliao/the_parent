...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WinningUser'
        db.create_table(u'account_winninguser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_winnging', to=orm['account.User'])),
            ('prize', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal(u'account', ['WinningUser'])


    def backwards(self, orm):
        # Deleting model 'WinningUser'
        db.delete_table(u'account_winninguser')
