...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReComment.like'
        db.add_column(u'movie_recomment', 'like',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Comment.like'
        db.add_column(u'movie_comment', 'like',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReComment.like'
        db.delete_column(u'movie_recomment', 'like')

        # Deleting field 'Comment.like'
        db.delete_column(u'movie_comment', 'like')
