...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Movie.watch_count'
        db.add_column(u'movie_movie', 'watch_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Movie.like'
        db.add_column(u'movie_movie', 'like',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Movie.watch_count'
        db.delete_column(u'movie_movie', 'watch_count')

        # Deleting field 'Movie.like'
        db.delete_column(u'movie_movie', 'like')
    ...
    models = {
        ...
        u'movie.movie': {
            ...
            'watch_count': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        u'movie.recomment': {
