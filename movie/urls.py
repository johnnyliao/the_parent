...
from movie.views import CommentPostView, ReCommentPostView, UnCommentLikeView, CommentLikeView, VideoLikeView, UnVideoLikeView
urlpatterns = patterns(".views",

	url('^comment/', CommentPostView.as_view()),
	url('^re_comment/', ReCommentPostView.as_view()),
	url('^like_comment/', CommentLikeView.as_view()),
	url('^unlike_comment/', UnCommentLikeView.as_view()),
