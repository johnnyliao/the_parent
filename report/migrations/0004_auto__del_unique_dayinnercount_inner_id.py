...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'DayInnerCount', fields ['inner_id']
        db.delete_unique(u'report_dayinnercount', ['inner_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'DayInnerCount', fields ['inner_id']
        db.create_unique(u'report_dayinnercount', ['inner_id'])
